...
import 'package:amit_flutter_final/src/views/forget_password_new_password/components/forge_password_new_password_app_bar.dart';
                    ...
                    children: [
                      Positioned(
                        ...
                        child: CustomStanderButton(
                          text: 'Reset Password',
                          onPress: ()=> Navigator.pushNamedAndRemoveUntil(context, ForgetPasswordSuccessScreen.route , (route) => false)
                        ),
                      ),
                    ],
                  ),
